...
1. Backfill embeddings for the remaining `11,848` transcript chunks in TEST when ready to spend the full embedding pass.
...
4. Tune vector fallback thresholds after the full embedding backfill is complete.
